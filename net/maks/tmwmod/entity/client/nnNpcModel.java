package net.maks.tmwmod.entity.client;// Made with Blockbench 4.10.3
...
public class nnNpcModel<T extends Entity> extends EntityModel<T> {
	// This layer location should be baked with EntityRendererProvider.Context in the entity renderer and passed into this model's constructor
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(new ResourceLocation("modid", "nnnpc"), "main");
	...
	public nnNpcModel(ModelPart root) {
